      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link
              to="/"
              className={`${isActive('/') ? 'text-amber-600' : 'text-gray-700 hover:text-amber-600'} transition`}
            >
              Home
            </Link>
            ...
            {profile ? (
              <>
                <Link
                  to="/dashboard"
                  className={`flex items-center gap-2 ${isActive('/dashboard') ? 'text-amber-600' : 'text-gray-700 hover:text-amber-600'} transition`}
                >
